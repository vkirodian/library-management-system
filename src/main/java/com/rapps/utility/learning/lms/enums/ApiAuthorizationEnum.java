...
public enum ApiAuthorizationEnum {
	...
	USERS_BY_FILTER("/lms/user/users", Arrays.asList(UserRoleEnum.SUPER_ADMIN, UserRoleEnum.LIBRARIAN)),
	USER_ADD("/lms/user/add", Arrays.asList(UserRoleEnum.SUPER_ADMIN)),
	USER_DELETE("/lms/user/users/", Arrays.asList(UserRoleEnum.SUPER_ADMIN)),
